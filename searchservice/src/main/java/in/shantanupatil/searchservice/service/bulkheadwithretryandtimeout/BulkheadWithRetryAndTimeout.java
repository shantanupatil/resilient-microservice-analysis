package in.shantanupatil.searchservice.service.bulkheadwithretryandtimeout;
...
@Service
@Profile("bulkhead-with-retry-timeout")
@RequiredArgsConstructor
public class BulkheadWithRetryAndTimeout implements AsyncSearchService {
